...
function AgentProfile() {
  ...
  let Customerdata = <>
           <tr className="">
            ...
            <td   key={OneCustomer._id}><button type="button" className="btn btn-primary" onClick={()=>{navigation('/editagentinagent',{state:{userName:OneCustomer.credential.userName}})}}>Edit</button></td>
            </tr>
            </>
