...
function CardMenuInsuranceInEmployee() {
    ...
    <Cards imageURL={'http://127.0.0.1:8090/api/files/h464b2ssrbuu1ts/wh84z4ql9oedrak/employeeedit2_AlhwE8TIH9.jpg'} URL={'/allinsuranceaccounts'} Title={'Insurance Account'} />
